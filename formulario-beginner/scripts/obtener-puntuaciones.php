                                                ...
                                                while ($puntuacion = $puntuaciones_equipo->fetch_assoc()):
                                                    ...
                                                    if ($i == 5) {
                                                        echo "<tr>
                                                            ...
                                                            <tr>
                                                                <td colspan='3' class='titulo' style='background-color: lightgreen; color: black; font-weight: normal;'><b>Opción 1:</b> Presentación de aplicaciones móviles Puntuación de vídeos</td>
                                                            </tr>";
                                                    }
                                                    if ($i == 9) {
                                                        echo "<tr>
                                                    ...
                                                    if ($i == 13) {
                                                        echo "<tr>
                                                                <td class='text-center' colspan='3' style='background-color: darkorange; color: white;'>".$categorias_nombre[3]."</td>
                                                            </tr>";
                                                    }
                                                endwhile;
                                        echo "</tbody>
                                    ...
                                    <div class='table-responsive'>
                                        <table class='table table-striped mb-2' id='tabla_puntuaciones_totales'>
                                            <tbody>
                                                ...
                                                <tr>
                                                  <td style='width: 90%;'>Puntuación total del Vídeo pitch</td>
                                                ...
                                                <tr>
                                                  <td style='width: 90%;'>Puntuación total del Camino de aprendizaje</td>
