...
if (isset($_POST['nombreEquipo']) && !empty($_POST['nombreEquipo']) && isset($_POST['puntuaciones'])) {
    ...
    if ($result_id_equipo->num_rows > 0) {
        ...
        if ($result_check_existence->num_rows == 0) {
            ...
            $sql_insertTotales = "INSERT INTO puntuaciones_totales (id_equipo, total_general, total_categoria1, total_categoria2, total_categoria3, total_categoria4) VALUES ('$idEquipo', '$totalGeneral', '$totalCategoria1', '$totalCategoria2', '$totalCategoria3', '$totalCategoria4')";
